...
form" role is gone; instead Tribunal builds a reviewable draft and stops. The
former Browserbase prize integration now lives as an OPTIONAL "autonomous draft
mode" described in TRIBUNAL_BUILD_DOC.md §2 — it types the draft values into the
...
if __name__ == "__main__":
    raise SystemExit(
        ...
        "Browserbase draft mode in TRIBUNAL_BUILD_DOC.md."
    )
